...
function construirSystemPrompt(catalogo, enfoqueProducto) {
            ...
            "LIMITE DURO DE PREGUNTAS DE DESCUBRIMIENTO: nunca hagas mas de 2 preguntas de descubrimiento seguidas (para que lo necesita, en que municipio o vereda, su situacion actual de conexion, etc) antes de recomendar una version puntual del modem. En cuanto hayas hecho esas 2 preguntas y tengas una respuesta minima (aunque no sea perfecta o completa), NO sigas preguntando mas detalles: recomienda con seguridad el modem 4G/5G (la opcion segura por defecto, ver mas abajo cual version recomendar) y pasa de inmediato a proponer el cierre. Quedarte haciendo mas y mas preguntas sin nunca recomendar una version especifica es el error mas grave que puedes cometer con el modem: satura al cliente y nunca avanza la venta.\n" +
